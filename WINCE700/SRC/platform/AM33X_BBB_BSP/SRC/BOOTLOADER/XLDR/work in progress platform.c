...
#define DDRPLL_M		303	/* M/N + 1 = 25/3 */
#define DDRPLL_N		23
#define DDRPLL_M2		1
...
void enable_ddr_clocks(void)
{
	...
	/* Poll for L3_G clock  are active */
	while ((INREG32(OALPAtoUA(CM_PER_L3_CLKSTCTRL)) & 
       PRCM_EMIF_CLK_ACTIVITY) != PRCM_EMIF_CLK_ACTIVITY);
}
...
{
	OUTREG32(OALPAtoUA(CMD0_CTRL_SLAVE_RATIO_0), DDR3_RATIO);
	OUTREG32(OALPAtoUA(CMD0_INVERT_CLKOUT_0), DDR3_INVERT_CLKOUT);
	OUTREG32(OALPAtoUA(CMD1_CTRL_SLAVE_RATIO_0), DDR3_RATIO);
	OUTREG32(OALPAtoUA(CMD1_INVERT_CLKOUT_0), DDR3_INVERT_CLKOUT);
	OUTREG32(OALPAtoUA(CMD2_CTRL_SLAVE_RATIO_0), DDR3_RATIO);
	OUTREG32(OALPAtoUA(CMD2_INVERT_CLKOUT_0), DDR3_INVERT_CLKOUT);
}
...
static void Data_Macro_Config(int dataMacroNum)
{
	...
	OUTREG32(
        ...
        ((DDR3_RD_DQS<<30)|(DDR3_RD_DQS<<20)|(DDR3_RD_DQS<<10)|(DDR3_RD_DQS<<0))
    );
	...
	OUTREG32(
        ...
        ((DDR3_WR_DQS<<30)|(DDR3_WR_DQS<<20)|(DDR3_WR_DQS<<10)|(DDR3_WR_DQS<<0))
    );
 ...
 //   );
	...
	OUTREG32(
        ...
        ((DDR3_PHY_FIFO_WE<<30)|(DDR3_PHY_FIFO_WE<<20)|(DDR3_PHY_FIFO_WE<<10)|(DDR3_PHY_FIFO_WE<<0))
    );
	...
	OUTREG32(
        ...
        ((DDR3_PHY_WR_DATA<<30)|(DDR3_PHY_WR_DATA<<20)|(DDR3_PHY_WR_DATA<<10)|(DDR3_PHY_WR_DATA<<0))
    );
...
static void config_emif_ddr(void)
{
	UINT32 i;

	/*Program EMIF0 CFG Registers*/
	OUTREG32(OALPAtoUA(EMIF4_0_DDR_PHY_CTRL_1),        DDR3_EMIF_READ_LATENCY);
	OUTREG32(OALPAtoUA(EMIF4_0_DDR_PHY_CTRL_1_SHADOW), DDR3_EMIF_READ_LATENCY);
	OUTREG32(OALPAtoUA(EMIF4_0_DDR_PHY_CTRL_2),        DDR3_EMIF_READ_LATENCY);

	OUTREG32(OALPAtoUA(EMIF4_0_SDRAM_TIM_1),        DDR3_EMIF_TIM1);
	OUTREG32(OALPAtoUA(EMIF4_0_SDRAM_TIM_1_SHADOW), DDR3_EMIF_TIM1);

	OUTREG32(OALPAtoUA(EMIF4_0_SDRAM_TIM_2),        DDR3_EMIF_TIM2);
	OUTREG32(OALPAtoUA(EMIF4_0_SDRAM_TIM_2_SHADOW), DDR3_EMIF_TIM2);

	OUTREG32(OALPAtoUA(EMIF4_0_SDRAM_TIM_3),        DDR3_EMIF_TIM3);
	OUTREG32(OALPAtoUA(EMIF4_0_SDRAM_TIM_3_SHADOW), DDR3_EMIF_TIM3);

	OUTREG32(OALPAtoUA(EMIF4_0_SDRAM_CONFIG),  DDR3_EMIF_SDCFG);
	OUTREG32(OALPAtoUA(EMIF4_0_SDRAM_CONFIG2), DDR3_EMIF_SDCFG2);
    ...
    */
	...
	OUTREG32(OALPAtoUA(EMIF4_0_SDRAM_ZQ_CONFIG),   DDR3_EMIF_ZQCR);
	...
	OUTREG32(OALPAtoUA(EMIF0_0_SDRAM_MGMT_CTRL_SHD), EMIF_SDMGT); 
    */
	OUTREG32(OALPAtoUA(EMIF4_0_SDRAM_REF_CTRL), DDR3_EMIF_SDREF);
	OUTREG32(OALPAtoUA(EMIF4_0_SDRAM_REF_CTRL_SHADOW), DDR3_EMIF_SDREF);
...
static void config_am33x_ddr(void)
{
	...
	OUTREG32(OALPAtoUA(DDR_CMD0_IOCTRL),  DDR3_IOCTRL_VALUE);
	OUTREG32(OALPAtoUA(DDR_CMD1_IOCTRL),  DDR3_IOCTRL_VALUE);
	OUTREG32(OALPAtoUA(DDR_CMD2_IOCTRL),  DDR3_IOCTRL_VALUE);

	OUTREG32(OALPAtoUA(DDR_DATA0_IOCTRL), DDR3_IOCTRL_VALUE);
	OUTREG32(OALPAtoUA(DDR_DATA1_IOCTRL), DDR3_IOCTRL_VALUE);
