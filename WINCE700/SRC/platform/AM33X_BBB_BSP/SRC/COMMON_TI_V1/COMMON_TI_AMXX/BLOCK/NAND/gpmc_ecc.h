...
#define ECC_BYTES_BCH8_ELM      (52)
#define ECC_BYTES_BCH8_ELMX     (56)
#define ECC_BYTES               ECC_BYTES_BCH8_ELMX  // no. of bytes used for ecc calculation. 
