...
#define GPIO2_PADS	\
    ...
    PAD_ENTRY(GPMC_ADVN_ALE,	MODE(7) | AM335X_PIN_INPUT_PULLUP)	/* GPIO2_2  TIMER4 */   \
    PAD_ENTRY(GPMC_OEN_REN,		MODE(7) | AM335X_PIN_INPUT_PULLUP)	/* GPIO2_3  TIMER7 */   \
    PAD_ENTRY(GPMC_WEN,			MODE(7) | AM335X_PIN_INPUT_PULLUP)	/* GPIO2_4  TIMER6 */   \
    PAD_ENTRY(GPMC_BE0N_CLE,	MODE(7) | AM335X_PIN_INPUT_PULLUP)	/* GPIO2_5  TIMER5 */   \
