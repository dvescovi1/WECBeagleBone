...
{
    return TPS65217_I2C_DEVICE_ID;
}

UINT16 BSPGetTritonSlaveAddress()
{
    return I2C_PMIC_ADDR;
}

//------------------------------------------------------------------------------
//  System Timer
//------------------------------------------------------------------------------
OMAP_DEVICE BSPGetSysTimerDevice(void)
{
	return AM_DEVICE_TIMER3;
}

DWORD BSPGetSysTimerFreqKHz(void)
{
	return 32;
}
...
//------------------------------------------------------------------------------
OMAP_DEVICE BSPGetGPTPerfDevice(void)
{
...
OMAP_CLOCK BSPGetGPTPerfHighFreqClock(UINT32* pFreq)
{
	...
	*pFreq = (UINT32)24000000;

	return kSYS_CLKIN_CK;
}
