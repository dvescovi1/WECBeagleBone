...
//
BOOL
OALKitlGetDevLoc(__out DEVICE_LOCATION *pDevLoc)
{
...
//
BOOL
OALKitlGetFlags(__out UINT32 *pFlags)
{
    if(pFlags)
...
//  and call KITL device class init function.
{
	...
	//KitlLogSetZones(0x0030/*|ZONE_KITL_OAL|ZONE_KITL_ETHER*/);
...
//
BOOL
OALKitlInit(__in_z LPCSTR deviceId, __in OAL_KITL_ARGS *pArgs, __in OAL_KITL_DEVICE *pDevice)
{
    BOOL rc = FALSE;
