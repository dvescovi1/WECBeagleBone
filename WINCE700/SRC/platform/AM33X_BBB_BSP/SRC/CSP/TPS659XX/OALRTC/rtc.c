...
{
    OALLogPrintf(
        buffer, count, L"%04d.%02d.%02d %02d:%02d:%02d.%03d",
    ...
    )
{
    ...
    // Set T2 MSECURE to be output/high (unsecure)
...
#ifdef SHIP_BUILD    
    UNREFERENCED_PARAMETER(buffer1);        
#endif  
