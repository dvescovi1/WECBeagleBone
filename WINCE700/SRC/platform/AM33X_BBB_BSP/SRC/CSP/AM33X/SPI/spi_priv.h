...
__inline BOOL SpiDmaTxEnabled(SPI_INSTANCE *pInstance){return( pInstance->hTxDmaChannel != NULL );}
__inline BOOL SpiDmaRxEnabled(SPI_INSTANCE *pInstance){return( pInstance->hRxDmaChannel != NULL );}
...
DWORD SPI_AsyncWriteRead(DWORD context, DWORD size, VOID *pOutBuffer, VOID *pInBuffer);
DWORD SPI_WaitForAsyncWriteReadComplete(DWORD context, DWORD size, VOID *pInBuffer);
DWORD SPI_DmaWriteRead(DWORD context, DWORD size, VOID *pOutBuffer, VOID *pInBuffer);
BOOL  SPI_SetSlaveMode(DWORD context);

BOOL  SPI_IOControl(DWORD context, DWORD dwCode, BYTE *pInBuffer, DWORD inSize,
