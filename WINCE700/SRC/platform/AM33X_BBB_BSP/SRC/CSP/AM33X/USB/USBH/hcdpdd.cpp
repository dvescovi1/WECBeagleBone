...
extern BOOL HcdPdd_Deinit(DWORD hDeviceContext)
{
    ...
    if (pPddObject)
    {
        ...
        if (pPddObject->pSysConfReg)
            MmUnmapIoSpace((PVOID)(pPddObject->pSysConfReg), sizeof(AM33X_DEVICE_CONF_REGS_PA));
