...
cleanUp:    
    OALMSG(OAL_INTR&&OAL_FUNC, (L"-OEMInterruptEnable(rc = 1)\r\n"));
    return rc;
}
...
VOID OEMInterruptDisable(DWORD sysIntr)
{
    ...
    OALMSG(OAL_INTR&&OAL_FUNC, (L"+OEMInterruptDisable(%d)\r\n", sysIntr));
...
cleanUp:
    // Indicate exit
    OALMSG(OAL_INTR&&OAL_FUNC, (L"-OEMInterruptDisable\r\n"));
}
    ...
    )
{
    ...
    OALMSG(OAL_INTR&&OAL_FUNC, (L"-OEMInterruptMask\r\n"));
}
...
VOID OEMInterruptDone(DWORD sysIntr)
{
    ...
    OALMSG(OAL_INTR&&OAL_FUNC, (L"+OEMInterruptDone(%d)\r\n", sysIntr));
    ...
    OALMSG(OAL_INTR&&OAL_FUNC, (L"-OEMInterruptDone\r\n"));
