    ...
    )
{
    ...
    if (memcmp(pEccOld, pEccNew, ECC_BYTES_HAMMING) == 0)
	return TRUE;
...
omap_gpmc_ecc_Func_t gpmc_ecc_bch8_elm =
{
    &BCH8_ECC_Init,
    &BCH8_ECC_Calculate,	
    &BCH8_ECC_Reset,    
    &BCH8_ELM_ECC_CorrectData
};

omap_gpmc_ecc_Func_t gpmc_ecc_bch8_elmx =
{
    &BCH8_ELMX_ECC_Init,
    &BCH8_ELMX_ECC_Calculate,	
    &BCH8_ECC_Reset,    
    &BCH8_ELMX_ECC_CorrectData
};
    ...
    )
{
    ...
    switch(ECC_mode)
    {
        ...
        case BCH8bitElm:
            gpmc_ecc_func = &gpmc_ecc_bch8_elm;
	    break;

        case BCH8bitElmX:
            gpmc_ecc_func = &gpmc_ecc_bch8_elmx;
	    break;
