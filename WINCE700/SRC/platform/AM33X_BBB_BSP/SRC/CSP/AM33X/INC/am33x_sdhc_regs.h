...
typedef volatile struct
{
    ...
    UINT32 unused2[51];			// 0x0034 - 0x00FC
	UINT32 MMCHS_SDMASA;		// 0x0100
    ...
    UINT32 unused5[1];			// 0x014C
    UINT32 MMCHS_FE;			// 0x0150
    UINT32 MMCHS_ADMAES;		// 0x0154
    UINT32 MMCHS_ADMASAL;		// 0x0158
    UINT32 MMCHS_ADMASAH;		// 0x015C
	UINT32 unused6[39];			// 0x0160 - 0x01F8
...
#define MMCHS_HCTL_DMAS_MODE32					(2)
