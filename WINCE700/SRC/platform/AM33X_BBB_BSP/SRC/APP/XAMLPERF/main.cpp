...
public:
    ...
    void UpdateFPS()
    {
        ...
        if (FPS != m_MostRecentFramerate)
        {
            ...
            StringCchPrintf(Text, MAX_PATH, L"%d FPS (%dx%d)", (int)FPS, (int)m_DisplayWidth, (int)m_DisplayHeight);
    ...
    void PrintStats()
    {
        ...
        RETAILMSG(1, (buffer));
        StringCchPrintf(buffer, MAX_PATH, L"[SAMPLE XAML PERF]: Application Memory Use: %d KB", (int)memUsage);
        RETAILMSG(1, (buffer));
